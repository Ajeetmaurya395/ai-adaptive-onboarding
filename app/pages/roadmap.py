...
def _resource_table_rows(roadmap: List[Dict]) -> List[Dict]:
    rows: List[Dict] = []
    for step in roadmap:
        resource_map = {item.get("type"): item for item in step.get("learning_resources", [])}
        rows.append({
            "Step": step.get("step"),
            ...
            "Documentation": resource_map.get("Documentation", {}).get("title", ""),
            "Free Video": resource_map.get("Free Video", {}).get("title", ""),
            "Book": resource_map.get("Book", {}).get("title", ""),
            "Practice": resource_map.get("Practice", {}).get("title", ""),
